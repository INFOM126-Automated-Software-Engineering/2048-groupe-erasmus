...
[<scope>]<type>: <subject>
```
- **scope**: optional, identifies the affected module or area (e.g. game, ui, readme, maven)
...
### Dependabot commits
Dependency update commits generated by Dependabot follow the Conventional Commits format:
```
chore(maven): bump dependency-name
```
This format is accepted as an exception for automated dependency updates.
